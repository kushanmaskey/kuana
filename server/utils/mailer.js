      ...
      <div style="font-family:sans-serif;max-width:600px;margin:0 auto">
        ...
        <div style="background:#f9fafb;padding:24px;border:1px solid #e5e7eb;border-top:none;border-radius:0 0 8px 8px">
          ...
          <table style="width:100%;border-collapse:collapse;margin-bottom:16px">
            ...
            <tr><td style="padding:8px 0;color:#6b7280">Email</td><td style="padding:8px 0"><a href="mailto:${safeEmail}" style="color:#dc143c">${safeEmail}</a></td></tr>
            ${subject ? `<tr><td style="padding:8px 0;color:#6b7280">Subject</td><td style="padding:8px 0;color:#111827">${safeSubject}</td></tr>` : ''}
          </table>
          <div style="background:#fff;border:1px solid #e5e7eb;border-radius:6px;padding:16px;white-space:pre-wrap;color:#374151">${safeMessage}</div>
