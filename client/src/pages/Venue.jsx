...
const VENUES = {
  ...
  'holiday-inn-trophy-club-2023': {
    ...
    photos: [
      '/assets/img/venue-gallery/trophy-club/HolidayInn1.webp',
      '/assets/img/venue-gallery/trophy-club/HolidayInn2.webp',
      '/assets/img/venue-gallery/trophy-club/HolidayInn3.webp',
      '/assets/img/venue-gallery/trophy-club/HolidayInn4.webp',
      '/assets/img/venue-gallery/trophy-club/HolidayInn5.webp',
      '/assets/img/venue-gallery/trophy-club/HolidayInn6.webp',
      '/assets/img/venue-gallery/trophy-club/HolidayInn7.webp',
      '/assets/img/venue-gallery/trophy-club/HolidayInn8.webp',
      '/assets/img/venue-gallery/trophy-club/HolidayInn9.webp',
      '/assets/img/venue-gallery/trophy-club/HolidayInn10.webp',
      '/assets/img/venue-gallery/trophy-club/HolidayInn11.webp',
      '/assets/img/venue-gallery/trophy-club/HolidayInn12.webp',
      '/assets/img/venue-gallery/trophy-club/HolidayInn13.webp',
      '/assets/img/venue-gallery/trophy-club/HolidayInn14.webp',
      '/assets/img/venue-gallery/trophy-club/HolidayInn15.webp',
      '/assets/img/venue-gallery/trophy-club/HolidayInn16.webp',
      '/assets/img/venue-gallery/trophy-club/HolidayInn17.webp',
      '/assets/img/venue-gallery/trophy-club/HolidayInn18.webp',
      '/assets/img/venue-gallery/trophy-club/HolidayInn19.webp',
      '/assets/img/venue-gallery/trophy-club/HolidayInn20.webp',
    ],
    facilities: [
      { icon: <Wifi size={18} />, label: 'Free WiFi' },
      { icon: <Dumbbell size={18} />, label: 'Fitness Center' },
